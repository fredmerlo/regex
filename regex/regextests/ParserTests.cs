...
namespace regextests
{
    ...
    public class ParserTests
    {
        ...
        public void Parser_Match_Returns_True_On_Additional_Valid_Input()
        {
            ...
            Assert.True(Parser.Instance("a.*a.*a.*a.a").Matches("abcccabcccabcccaba"));
        }
        ...
        [Test]
        public void Parser_Instance_Should_It_Return_True_On_Additional_Valid_Input()
        {
            //I think it should but how to know when to stop after *
            Assert.True(Parser.Instance(".*a").Matches("aaaa")); 
        }
    }
}
